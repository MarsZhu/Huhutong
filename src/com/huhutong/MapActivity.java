...
public class MapActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
         ...
         */
        HuhutongApplication app = (HuhutongApplication)this.getApplication();
        if (app.mBMapManager == null) {
            app.mBMapManager = new BMapManager(getApplicationContext());
            /**
             * 如果BMapManager没有初始化则初始化BMapManager
             */
            app.mBMapManager.init(HuhutongApplication.strKey,new HuhutongApplication.MyGeneralListener());
        }
        /**
		...
		mMapView.regMapViewListener(HuhutongApplication.getInstance().mBMapManager, mMapListener);
    }
